...
# Hàm để tính toán tổng weight cho mỗi địa điểm dựa trên trip_type của năm target_year
...
trip_type_weights_2023 = calculate_weights_by_trip_type(data, 2022)
top_attractions_by_trip_type_2023 = get_top_attractions_by_trip_type(trip_type_weights_2023)

# Plot pie chart for trip types for 2023
plot_pie_chart(top_attractions_by_trip_type_2023, 'Top Attractions by Total Weight for Each Trip Type (2022)')
